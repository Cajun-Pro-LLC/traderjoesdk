...
// APIClient manages communication with the Trader Joe Dex API API v1.0.0
...
type APIClient struct {
	...
	DexAnalyticsAPI DexAnalyticsAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DexAnalyticsAPI = (*DexAnalyticsAPIService)(&c.common)
